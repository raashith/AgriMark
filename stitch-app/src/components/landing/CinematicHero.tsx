...
export const CinematicHero: React.FC = () => {
  return (
    <section className="relative min-h-[95vh] pt-28 pb-16 md:pt-36 md:pb-24 flex flex-col justify-between overflow-hidden bg-gradient-to-b from-[#19201D] via-[#1B4D3E] to-[#143B30] text-white">
      {/* Ambient Atmospheric Sunrise Lighting & Organic Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-gradient-to-br from-[#E5A93C]/20 via-[#3E7B54]/30 to-transparent rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 right-[-10%] w-[600px] h-[600px] bg-[#1B4D3E]/40 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10 w-full flex-1 flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            {/* Eyebrow Pill */}
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 bg-emerald-950/80 border border-[#E5A93C]/40 rounded-full backdrop-blur-md shadow-lg">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight leading-[1.05] text-white font-sans">
            ...
            {/* Supporting Copy */}
            <p className="text-base sm:text-lg md:text-xl text-emerald-100/90 max-w-2xl font-normal leading-relaxed">
            ...
            {/* Trust Markers */}
            <div className="pt-6 border-t border-emerald-900/60 flex flex-wrap items-center gap-6 text-xs text-emerald-200/80 font-medium">
          ...
          {/* Right Column: High-End Live Interactive Deck Mockup */}
          <div className="lg:col-span-5 relative">
            {/* Soft Ambient Card Glow */}
            <div className="absolute -inset-1 bg-gradient-to-r from-[#E5A93C] via-emerald-500 to-[#3E7B54] rounded-3xl blur-xl opacity-30 animate-pulse" />

            <div className="relative bg-[#19201D]/90 border border-emerald-700/60 rounded-3xl p-6 shadow-2xl backdrop-blur-xl space-y-5">
              {/* Card Header: Live Mandi Intelligence & Cadastral Status */}
              ...
              {/* Price Ticker Mock */}
              <div className="bg-[#143B30]/80 border border-emerald-800/80 rounded-2xl p-4 space-y-3">
              ...
              {/* Verified Produce Lot Details */}
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="bg-[#19201D] p-3 rounded-xl border border-emerald-900/60 space-y-1">
              ...
              {/* Multilingual AI Teaser */}
              <div className="p-3 bg-gradient-to-r from-amber-500/10 via-emerald-900/30 to-transparent border border-amber-400/30 rounded-xl flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
      ...
      <div className="relative z-10 text-center pt-8">
        <a
          href="#platform"
          className="inline-flex items-center gap-2 text-xs font-mono font-semibold text-emerald-300/70 hover:text-[#E5A93C] transition"
        >
